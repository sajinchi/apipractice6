...
import { Update } from "@/app/services/product.services";
import React, { useState } from "react";
import { useForm } from "react-hook-form";

const UpdateItem = (props: { id: number;title:string;desc:string;price:number;discount:number;stock:number;brand:string;category:string; update: any }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
